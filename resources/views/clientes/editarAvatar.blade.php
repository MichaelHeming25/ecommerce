<form class="form-horizontal" id="form" role="form" action="{{ url('/avatar/editar') }}/{{ $id }}" method="POST" enctype="multipart/form-data" >
	...
	<div class="group-avatar">
        ...
        <div class="input-group">
            ...
            <label class="preview" for="inputGroupFile04">Escolha uma imagem <i class="fas fa-upload"></i></label>
        </div>
        <img style="width:64px;height:64px;border-radius:100%;" name="avatar">
    </div>
